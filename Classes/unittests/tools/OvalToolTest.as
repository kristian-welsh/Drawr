package unittests.tools{
	...
	public class OvalToolTest extends TestCase {
		...
		private var _oval_tool_instance:OvalTool;
		...
		protected override function setUp():void {
			_oval_tool_instance = new OvalTool();
		}
		...
		public function testInitialisation():void {
			assertTrue("the instance is an OvalTool",_oval_tool_instance is OvalTool);
		}
		...
		public function testMouseDown():void {
			_oval_tool_instance.mouseDown(0,0,0x000000);
			
			var modified_art:Shape = _oval_tool_instance.art as Shape;
		...
		public function testMouseMove():void {
			_oval_tool_instance.mouseDown(0,0,0x000000);//required
			_oval_tool_instance.mouseMove(100,100);
		...
		public function testMouseUp():void {
			_oval_tool_instance.mouseDown(0,0,0x000000);//required
			_oval_tool_instance.mouseMove(100,100);//required
			
			var bmp1:BitmapData = bitmapData(_oval_tool_instance.art);//art before being drawn
			
			_oval_tool_instance.mouseUp(100,100);
			
			var bmp2:BitmapData = bitmapData(_oval_tool_instance.art);//art after being drawn
			
			assertTrue("returned art after mouseDown, mouseMove, then mouseUp isn't empty",hasContent(_oval_tool_instance.art));
		...
		public function testGetArt():void {
			_oval_tool_instance.mouseDown(0,0,0x000000);
			assertTrue("returns an empty DisplayObject after mouseDown",_oval_tool_instance.art is DisplayObject);
		}
